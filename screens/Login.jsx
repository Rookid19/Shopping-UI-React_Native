...
const Login = ({ navigation }) => {
   ...
   const signIn = () => {
      auth
         .signInWithEmailAndPassword(email, password) // we didnt write any promise after the email and password because is a listener in the useEffect called unsubscribe
   ...
   return (
      ...
      <StyledContainer>
         ...
         <InnerContainer>
            <PageTitle style={styles.medium}>HEY THERE</PageTitle>
